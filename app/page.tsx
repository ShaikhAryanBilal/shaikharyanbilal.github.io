...
const TECH_ICONS: Record<string, ReactNode> = {
  ...
  "REST APIs": (
    <Stroke>
      <path d="M8 3a3 3 0 0 0-3 3v2a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2v2a3 3 0 0 0 3 3" />
      <path d="M16 3a3 3 0 0 1 3 3v2a2 2 0 0 0 2 2v4a2 2 0 0 0-2 2v2a3 3 0 0 1-3 3" />
    </Stroke>
  ),
  "Responsive Design": (
    <Stroke>
  ...
  "Secure Coding": (
    <Stroke>
      <path d="M12 2l7 3v6c0 4.4-3 8.6-7 10-4-1.4-7-5.6-7-10V5l7-3z" />
...
const allTechItems = home.skills.flatMap((s) => s.items);
const techItems = [
  ...allTechItems.filter((t) => !GENERIC_TECH.includes(t)),
  ...allTechItems.filter((t) => GENERIC_TECH.includes(t)),
];
              ...
              <ul className="tech-grid">
                {techItems.map((t) => (
                  <li
                    key={t}
                    className="tech-tile"
                    style={{ "--brand": TECH_BRANDS[t] ?? "var(--accent)" } as CSSProperties}
                  >
                    <span className="tech-badge">{TECH_ICONS[t] ?? DEFAULT_TECH_ICON}</span>
